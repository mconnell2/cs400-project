...
public class Main extends Application {
		...
		filterButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				ruleStage.setOnCloseRequest(windowEvent -> {
					...
					foodList.setItems(foodItemList);
					foodList.refresh();
					//TODO: the food count (since it may have been filtered) should be refreshed too at this point
	...
	/**
	 * Updates the nutrition info Grid
	 * This occurs upon adding new food items and clearing the meal
	 * 
	 ...
	 */
	private void updateNutrition(GridPane mealGrid, Text calories, Text fat, Text carbs, Text fiber, Text protein, PieChart pieChart) {
